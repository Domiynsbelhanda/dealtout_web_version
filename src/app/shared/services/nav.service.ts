...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'immo', type: 'link', active: false, path: 'mambo'
		},
		{
			title: 'phone', type: 'link', active: false, path: 'battle'
		},
		{
			title: 'habillement', type: 'link', active: false, path: 'belhanda'
		},
		{
			title: 'autres', type: 'link', active: false, path: '/home/belhanda'
		}
	];
